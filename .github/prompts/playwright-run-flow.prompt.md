...
- Application code exists in `/project/src` folder for context and analysis.
...
7) Include context from `/project/src` analysis in notes (e.g., "Based on /project/src/templates/login.html, validated selector #username")
